...
const defaultPolygonOffset = _objectSpread({}, defaultOffset, {
  enable: (context, props) => {
    return props.polygonOffset && props.polygonOffset.enable || defaultOffset.enable;
  },
  offset: (context, props) => props.polygonOffset && props.polygonOffset.offset || defaultOffset.offset
