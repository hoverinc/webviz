...
const viewSelector = reselect.createSelector(stateSelector, orientationSelector, positionSelector, targetHeadingSelector, rollSelector, ({
  view,
  target,
  targetOffset,
  perspective,
  principalAxis
}, orientation, position, targetHeading, roll) => {
  ...
  glMatrix.mat4.multiply(m, m, glMatrix.mat4.fromQuat(TEMP_MAT, glMatrix.quat.invert(TEMP_QUAT, orientation)));

  if (principalAxis) {
    // 4.5 rotate the camera about its principal axis
    glMatrix.mat4.multiply(m, m, glMatrix.mat4.fromRotation(TEMP_VEC3, roll, principalAxis));
